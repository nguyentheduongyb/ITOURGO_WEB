...
let priceAdult = 120000
let priceChild = 120000

let totalPriceAdult = priceAdult
let totalPriceChild = priceChild

let totalPrice = priceAdult + priceChild
function plus(ages) {
    if (ages == "adult") {
        counterAdult += 1;
        ...
        counterChild += 1;
        totalPriceChild = priceChild * counterChild
        
        document.getElementById("counterChild").innerHTML = counterChild;
        document.getElementById("counterChild").innerHTML = counterChild;
        document.getElementById("pngTotalPriceChild").innerHTML = `x ${totalPriceChild}`;
    }

    totalPrice = totalPriceAdult + totalPriceChild
    document.getElementById("pngTotalPrice").innerHTML = `x ${totalPrice}`;
    ...
    const ObjList_Api = {
        GetListPriceLevelTour: {
            ...
            , objParams: 
            {
                ...
                strTourGUID: "070ccf2d-0012-4dca-a281-6d0928543a6d",
                strPriceLevelGUID: "6447338A-2276-48A8-A461-DFEC0AAEF360",
                intNoOfAdult: 2,
                xmlNoOfChild: "<child>4</child>",
                intNoOfSGLSup: 0,
                intNoOfTPLRec: 0,
                dtmFilterDateFrom: "1/7/2021",
                dtmFilterDateTo: '',
                intCurrencyView: 1,
                strCompanyOwnerGUID: "659ac96f-6a25-488c-9476-0e22349c6283",
                IsHasPriceKid: false,
                intCateID: 18,
                intEasiaCateID: 2,
                intJoinTypeID: 1,
                intTransportOptionID: '',
                intCurPage: '',
                intPageSize: '',
                strOrder: '',
                tblsReturn: "[0]"
...
<div class="w-full bg-white rounded-sm p-4 drop-shadow-[0_0_10px_rgba(0,0,0,0.25)] rounded-lg mb-3">
                                                        <h3 class="mb-3 text-[color:let(--primary-color)] text-xl font-bold">Lịch khởi hành & Giá</h3>
                                                        ...
                                                        <p class='flex items-center mt-3 gap-3 text-[color:let(--primary-color)]'><HiOutlineInformationCircle /><span>Liên hệ để xác nhận chỗ</span></p>
                                                        <div class="mt-3">
                                                                ...
                                                                <p class="flex justify-between mt-2 items-center">
                                                                        <span>Tổng cộng</span>
                                                                        <span id="pngTotalPrice" class="font-medium text-2xl text-orange-500">${totalPrice} VNĐ</span>
                                                                </p>
                                                        </div>
                                                        <div class="flex grid grid-cols-2 gap-4 mt-5">
                                                                <button id="" class="png-Btn-Payment border border-[color:let(--primary-color)] bg-white p-3 text-center text-[color:let(--primary-color)] rounded font-bold text-lg">Đặt cọc</button>
                                                                <a class="bg-[color:let(--primary-color)] p-3 text-center text-white rounded font-bold text-lg" href="/tour/payment-detail?id=6529781ad74bcb42243b43e1&adult=2&child=1">Yêu cầu đặt</a>
                                                ...
                                                <div class="bg-white rounded-sm p-4 drop-shadow-[0_0_10px_rgba(0,0,0,0.25)] rounded-lg mb-3">
                                                        <div class="flex grid grid-cols-2 gap-4">
                                                                <div class="flex items-center gap-2 w-full">
                                                                        <BsCheckLg class="text-[color:let(--primary-color)]" />
                                                                        <span>Bảo hiểm</span>
                                                                </div>
                                                                <div class="flex items-center gap-2 w-full">
                                                                        <BsCheckLg class="text-[color:let(--primary-color)]" />
                                                                                ...
                                                                                <div>
                                                                                        <div>
                                                                                                ...
                                                                                                <div class="flex gap-4 mb-4 items-center">
                                                                                                        <p class="text-[color:let(--primary-color)] text-xl font-medium">PNGSOFT</p>
                                                                                                        <span>|</span>
                                                                                        ...
                                                                                        <div class="flex py-3 justify-between">
                                                                                                ...
                                                                                                <button id="pngBtnPayment" class="py-2 px-4 bg-[color:let(--primary-color)] text-white font-bold rounded-xl">Thanh toán</button>
                                                                                        </div>
                                                                                </div>
                                                                        </div>
                                                                </div>
